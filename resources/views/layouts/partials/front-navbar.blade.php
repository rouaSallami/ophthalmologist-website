<nav id="navbar" class="fixed top-0 inset-x-0 z-50 transition-transform duration-300">
...
<div class="hidden md:flex items-center gap-2 lg:gap-3">
    ...
    <a href="tel:+21600000000"
        class="inline-flex items-center gap-2 rounded-xl border border-[#B4C0D9]/50 bg-white/70 
        px-3 md:px-4 py-2 text-xs md:text-sm font-medium text-[#1B2A59] 
        hover:border-[#143373] hover:bg-[#F2E6DF]/35 transition">
    ...
    <a href="{{ route('appointment.create') }}"
        class="inline-flex items-center gap-2 rounded-xl bg-[#143373] text-white 
        px-3 md:px-4 lg:px-5 py-2 text-xs md:text-sm font-semibold 
        shadow-[0_12px_30px_rgba(20,51,115,0.30)] 
        hover:bg-[#1B2A59] hover:-translate-y-0.5 transition duration-300">
        
        <span class="hidden sm:inline">Book</span>
        <span class="hidden lg:inline">Appointment</span>
...
lastScroll = currentScroll;
    ...
    const isMenuButton = menuButton.contains(e.target);
